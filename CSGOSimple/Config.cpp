...
void ConfigSys::SaveConfig(const std::string path)
{
	...
	Save(g_Options.Recoil_crosshair, "Recoil_crosshair");
	Save(g_Options.misc_hitmarker, "hitmarker"); Save(g_Options.Hitsound, "hitsound");
	//chams
	Save(g_Options.chams_player_enabled, "chams_player_enabled");
	Save(g_Options.chams_player_enemies_only, "chams_enemies_only");
	Save(g_Options.chams_player_wireframe, "chams_player_wireframe");
	Save(g_Options.chams_player_flat, "chams_player_flat");
	Save(g_Options.chams_player_ignorez, "chams_player_ignorez");
	Save(g_Options.chams_player_glass, "chams_player_glass");
	Save(g_Options.chams_weapon_materials_enabled, "chams_weapon_materials_enabled");
	Save(g_Options.chams_arms_materials, "chams_arms_materials");
	Save(g_Options.chams_weapon_materials, "chams_weapon_materials");
	Save(g_Options.chams_weapon_enabled, "chams_weapon_enabled");
	Save(g_Options.chams_weapon_wireframe, "chams_weapon_wireframe");
	Save(g_Options.chams_weapon_flat, "chams_weapon_flat");
	Save(g_Options.chams_weapon_ignorez, "chams_weapon_ignorez");
	Save(g_Options.chams_weapon_glass, "chams_weapon_glass");
	Save(g_Options.chams_arms_materials_enabled, "chams_arms_materials_enabled");
	Save(g_Options.chams_arms_enabled, "chams_arms_enabled");
	Save(g_Options.chams_arms_wireframe, "chams_arms_wireframe");
	Save(g_Options.chams_arms_flat, "chams_arms_flat");
	Save(g_Options.chams_arms_ignorez, "chams_arms_ignorez");
	Save(g_Options.chams_arms_glass, "chams_arms_glass");
	...
	SaveColor(g_Options.color_chams_arms_visible, "color_chams_arms_visibler");
	SaveColor(g_Options.color_chams_weapon_visible, "color_chams_weapon_visible");
	SaveColor(g_Options.color_chams_weapon_occluded, "color_chams_weapon_occluded");
	SaveColor(g_Options.color_chams_arms_occluded, "color_chams_arms_occluded");
	//Legitbot
	Save(g_Options.aim_enabled, "legitbot");
	//Legitbot - rifles
	...
	//ragebot
	Save(g_Options.best_resolver, "resolver");
	Save(g_Options.aim_fov, "aim_fov");
	Save(g_Options.aim_auto_shoot, "aim_auto_shoot");
	Save(g_Options.aim_silent_mode, "aim_silent_mode");
	Save(g_Options.auto_wall, "auto_wall");
	Save(g_Options.auto_wall_mindamange, "auto_wall_mindamange");
	Save(g_Options.hit_chance, "hit_chance");
	Save(g_Options.multipointer, "multipointer");
	Save(g_Options.vecvelocityprediction, "vecvelocityprediction");
	Save(g_Options.hit_chanceamount, "hit_chanceamount");
	Save(g_Options.enginepred, "enginepred");
	Save(g_Options.Remove_recoil, "norecoil");
...
void ConfigSys::LoadConfig(const std::string path)
{
	...
	Load(g_Options.chams_player_enemies_only, "chams_enemies_only");
	Load(g_Options.chams_player_wireframe, "chams_player_wireframe");
	Load(g_Options.chams_player_flat, "chams_player_flat");
	Load(g_Options.chams_player_ignorez, "chams_player_ignorez");
	Load(g_Options.chams_player_glass, "chams_player_glass");
	Load(g_Options.chams_weapon_materials_enabled, "chams_weapon_materials_enabled");
	Load(g_Options.chams_arms_materials, "chams_arms_materials");
	Load(g_Options.chams_weapon_materials, "chams_weapon_materials");
	Load(g_Options.chams_weapon_enabled, "chams_weapon_enabled");
	Load(g_Options.chams_weapon_wireframe, "chams_weapon_wireframe");
	Load(g_Options.chams_weapon_flat, "chams_weapon_flat");
	Load(g_Options.chams_weapon_ignorez, "chams_weapon_ignorez");
	Load(g_Options.chams_weapon_glass, "chams_weapon_glass");
	Load(g_Options.chams_arms_materials_enabled, "chams_arms_materials_enabled");
	Load(g_Options.chams_arms_enabled, "chams_arms_enabled");
	Load(g_Options.chams_arms_wireframe, "chams_arms_wireframe");
	Load(g_Options.chams_arms_flat, "chams_arms_flat");
	Load(g_Options.chams_arms_ignorez, "chams_arms_ignorez");
	Load(g_Options.chams_arms_glass, "chams_arms_glass");
	...
	LoadColor(&g_Options.color_chams_arms_visible, "color_chams_arms_visibler");
	LoadColor(&g_Options.color_chams_weapon_visible, "color_chams_weapon_visible");
	LoadColor(&g_Options.color_chams_weapon_occluded, "color_chams_weapon_occluded");
	LoadColor(&g_Options.color_chams_arms_occluded, "color_chams_arms_occluded");
	//Legitbot
	Load(g_Options.aim_enabled, "legitbot");
	//Legitbot - rifles
	...
	Load(g_Options.aim_fov, "aim_fov");
	Load(g_Options.aim_auto_shoot, "aim_auto_shoot");
	Load(g_Options.aim_silent_mode, "aim_silent_mode");
	Load(g_Options.auto_wall, "auto_wall");
	Load(g_Options.auto_wall_mindamange, "auto_wall_mindamange");
	Load(g_Options.hit_chance, "hit_chance");
	Load(g_Options.multipointer, "multipointer");
	Load(g_Options.vecvelocityprediction, "vecvelocityprediction");
	Load(g_Options.hit_chanceamount, "hit_chanceamount");
	Load(g_Options.enginepred, "enginepred");
...
std::vector<std::string> ConfigSys::GetAllConfigs()
{
	...
	std::string fPath = std::string(Global::my_documents_folder) + "\\platinumwolf\\";
